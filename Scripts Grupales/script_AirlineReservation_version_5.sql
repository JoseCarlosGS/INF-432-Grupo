...
-------------- METODO PARA ELIMINAR LAS RESTRICCIONES DE LLAVES FORANEAS DE LA ACTUAL BD ------------
...
------------- METODO PARA ELIMINAR TODA LAS TABLAS SIN RESTRICCIONES ------------------
DECLARE @sql NVARCHAR(MAX) = N'';
...
FROM 'D:\Soporte\NUMERO_VUELO.csv'
WITH (
    FIRSTROW = 1,
    FIELDTERMINATOR = ',',
    ROWTERMINATOR = '\n'
